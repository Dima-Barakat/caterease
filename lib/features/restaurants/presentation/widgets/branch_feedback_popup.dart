...
class BranchFeedbackPopup extends StatefulWidget {
  final int branchId;
  final String branchName;

  const BranchFeedbackPopup({
    Key? key,
  ...
  @override
  _BranchFeedbackPopupState createState() => _BranchFeedbackPopupState();
}

class _BranchFeedbackPopupState extends State<BranchFeedbackPopup> {
  ...
  Future<void> _submitFeedback() async {
    ...
    try {
      final Map<String, dynamic> requestBody = {
        'target_type':
            'branch', // Using restaurant as target_type for branches too
        'target_id': widget.branchId,
        'type': _feedbackType,
